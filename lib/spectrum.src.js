...
var View = function (proto, params) {
    this._proto = proto;
    this._content = '';
    this.params = params;
};
...
Template.prototype.createInstance = function (params) {
    return new this.templateClass(this.templateClass, params);
};
...
Renderer.prototype.render = function (templatePath, params) {
    return this.defaultTemplateRoot.loadTemplate(templatePath).then(function (template) {
